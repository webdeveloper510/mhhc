...
use GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Support\Arr;
use GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Support\Str;
use GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Support\Fluent;
use GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Support\MessageBag;
use GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Contracts\Container\Container;
use GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator;
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\File\UploadedFile;
use GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Contracts\Container\Container
     */
    protected $container;
     ...
     *
     * @var \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     *
     * @return \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @param  \GravityKit\GravityImport\Foundation\ThirdParty\Illuminate\Contracts\Container\Container  $container
     * @return void
     */
