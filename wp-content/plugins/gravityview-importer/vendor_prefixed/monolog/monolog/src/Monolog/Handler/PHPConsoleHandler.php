...
use Exception;
use GravityKit\GravityImport\Foundation\ThirdParty\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \GravityKit\GravityImport\Foundation\ThirdParty\Monolog\Logger('all', array(new \GravityKit\GravityImport\Foundation\ThirdParty\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('GravityKit\\GravityImport\\Foundation\\ThirdParty\\Monolog\\'), // array Hide calls of classes started with...
