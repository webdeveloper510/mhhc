...
namespace GravityKit\GravityImport\Symfony\Component\Finder\Tests;

use GravityKit\GravityImport\Symfony\Component\Finder\Finder;

class FinderTest extends Iterator\RealIteratorTestCase
{
    public function testCreate()
    {
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\Finder\Finder', Finder::create());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityImport\\Symfony\\Component\\Finder\\Finder', Finder::create()->append([]));
    }
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                ...
                $expectedExceptionClass = 'GravityKit\\GravityImport\\Symfony\\Component\\Finder\\Exception\\AccessDeniedException';
