...
class FileTest extends TestCase
{
    ...
    public function testMove()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\HttpFoundation\File\File', $movedFile);
    ...
    {
        $guesser = $this->getMockBuilder('GravityKit\GravityImport\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface')->getMock();
        $guesser
            ->expects($this->once())
            ->method('guess')
