...
namespace GravityKit\GravityImport\Symfony\Component\HttpFoundation\Tests;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\Request;
...
class RequestTest extends TestCase
{
    ...
    {
        $this->expectException('GravityKit\GravityImport\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException');
        $request = new Request();
    ...
    {
        $class = new \ReflectionClass('GravityKit\\GravityImport\\Symfony\\Component\\HttpFoundation\\Request');
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "GravityKit\GravityImport\Symfony\Component\HttpFoundation\Request::setTrustedHeaderName()" method is deprecated since Symfony 3.3 and will be removed in 4.0. Use the $trustedHeaderSet argument of the Request::setTrustedProxies() method instead.
     */
