...
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\Response;
...
class ResponseTest extends ResponseTestCase
{
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\HttpFoundation\Response', $response);
    ...
    {
        $headerMock = $this->getMockBuilder('GravityKit\GravityImport\Symfony\Component\HttpFoundation\ResponseHeaderBag')->setMethods(['set'])->getMock();
