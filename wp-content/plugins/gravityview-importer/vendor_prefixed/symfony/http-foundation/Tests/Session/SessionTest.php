...
namespace GravityKit\GravityImport\Symfony\Component\HttpFoundation\Tests\Session;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag;
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\Session\Flash\FlashBag;
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\Session\Session;
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\Session\SessionBagProxy;
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
...
{
    /**
     * @var \GravityKit\GravityImport\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \GravityKit\GravityImport\Symfony\Component\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityImport\\Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
