...
use GravityKit\GravityImport\Symfony\Component\HttpFoundation\StreamedResponse;
...
class StreamedResponseTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\HttpFoundation\StreamedResponse', $response);
    ...
    public function testReturnThis()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendContent());
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendContent());

        $response = new StreamedResponse(function () {});
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
        $this->assertInstanceOf('GravityKit\GravityImport\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
    }
