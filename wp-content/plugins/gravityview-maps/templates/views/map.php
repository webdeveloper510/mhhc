...
$gravityview->template->get_template_part( 'map/map', 'header' );
$gravityview->template->get_template_part( 'map/map', 'body' );
$gravityview->template->get_template_part( 'map/map', 'footer' );
