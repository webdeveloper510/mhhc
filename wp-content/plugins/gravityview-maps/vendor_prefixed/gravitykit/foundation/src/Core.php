...
namespace GravityKit\GravityMaps\Foundation;

use GravityKit\GravityMaps\Foundation\Integrations\GravityForms;
use GravityKit\GravityMaps\Foundation\Integrations\HelpScout;
use GravityKit\GravityMaps\Foundation\Integrations\TrustedLogin;
...
use GravityKit\GravityMaps\Foundation\WP\AjaxRouter;
use GravityKit\GravityMaps\Foundation\CLI\CLI;
use GravityKit\GravityMaps\Foundation\WP\PluginActivationHandler;
...
use GravityKit\GravityMaps\Foundation\Translations\Framework as TranslationsFramework;
use GravityKit\GravityMaps\Foundation\Encryption\Encryption;
...
HTML;
				...
				$general_settings = array_merge(
					...
					[
						[
							...
							'title'       => esc_html__( 'Group GravityKit Products', 'gk-gravitymaps' ),
							'description' => esc_html__( 'Aggregate all GravityKit products into a single entry on the Plugins page for a cleaner view and easier management.', 'gk-gravitymaps' ),
						],
						[
						...
						[
							...
							'title'       => esc_html__( 'Display "Powered By" Link', 'gk-gravitymaps' ),
							'description' => esc_html__( 'A "Powered by GravityKit" link will be displayed below some GravityKit products. Help us spread the word!', 'gk-gravitymaps' ),
						],
						[
							'id'          => 'affiliate_id',
							'type'        => 'number',
							'value'       => Arr::get( $gk_settings, 'affiliate_id' ),
							'title'       => esc_html__( 'Affiliate ID', 'gk-gravitymaps' ),
							'description' => strtr(
								esc_html_x( 'Earn money when people clicking your links become GravityKit customers. [link]Register as an affiliate[/link]!', 'Placeholders inside [] are not to be translated.', 'gk-gravitymaps' ),
								[
						...
						[
							...
							'title'       => esc_html__( 'Become a Beta Tester', 'gk-gravitymaps' ),
							'description' => esc_html__( 'You will have early access to the latest GravityKit products. There may be bugs! If you encounter an issue, report it to help make GravityKit products better!', 'gk-gravitymaps' ),
						],
					]
				);
				...
				$support_settings = [
					[
						...
						'title'       => esc_html__( 'Support Email', 'gk-gravitymaps' ),
						'description' => esc_html__( 'In order to provide responses to your support requests, please provide your email address.', 'gk-gravitymaps' ),
						'validation'  => [
							[
								'rule'    => 'required',
								'message' => esc_html__( 'Support email is required', 'gk-gravitymaps' ),
							],
							[
								'rule'    => 'email',
								'message' => esc_html__( 'Please provide a valid email address', 'gk-gravitymaps' ),
							],
						],
					],
					[
						...
						'title'       => esc_html__( 'Show Support Port', 'gk-gravitymaps' ),
						'description' => ( esc_html__( 'The Support Port provides quick access to how-to articles and tutorials. For administrators, it also makes it easy to contact support.', 'gk-gravitymaps' ) .
						                   strtr(
							                   esc_html_x( '[image]Support Port icon[/image]', 'Placeholders inside [] are not to be translated.', 'gk-gravitymaps' ),
							                   [
				...
				$technical_settings = [
					[
						...
						'title'       => esc_html__( 'Enable No-Conflict Mode', 'gk-gravitymaps' ),
						'description' => esc_html__( 'No-conflict mode prevents extraneous scripts and styles from being printed on GravityKit admin pages, reducing conflicts with other plugins and themes.', 'gk-gravitymaps' ),
					],
				];
				...
				$all_settings = [
					self::ID => [
						...
						'sections' => [
							[
								'title'    => esc_html__( 'General', 'gk-gravitymaps' ),
								'settings' => $general_settings,
							],
							[
								'title'    => esc_html__( 'Support', 'gk-gravitymaps' ),
								'settings' => $support_settings,
							],
							[
								'title'    => esc_html__( 'Technical', 'gk-gravitymaps' ),
	...
	public function get_foundation_information(): array {
		...
		$source_plugin_name = $source_plugin['Name'] ?? __( 'Unknown Plugin', 'gk-gravitymaps' );
		$loaded_by_message  = strtr(
			_x( 'GravityKit Foundation [version] (loaded by [plugin]).', 'Placeholders inside [] are not to be translated.', 'gk-gravitymaps' ),
			[
				'[version]' => $version,
