...
namespace GravityKit\GravityMaps\Foundation\Logger;
...
use GravityKit\GravityMaps\Foundation\ThirdParty\Monolog\Handler\ChromePHPHandler;
use GravityKit\GravityMaps\Foundation\ThirdParty\Monolog\Handler\StreamHandler;
use GravityKit\GravityMaps\Foundation\ThirdParty\Monolog\Logger as MonologLogger;
...
use Exception;
use GravityKit\GravityMaps\Foundation\ThirdParty\Psr\Log\LoggerInterface;
use GravityKit\GravityMaps\Foundation\ThirdParty\Psr\Log\LoggerTrait;
...
CSS;
		...
		$query_monitor_notice = strtr(
			esc_html_x( 'You must install [link]Query Monitor[/link] WordPress plugin to use this option.', 'Placeholders inside [] are not to be translated.', 'gk-gravitymaps' ),
			[
		...
		$chrome_logger_tip = strtr(
			esc_html_x( 'You must install [link]Chrome Logger[/link] browser extension to use this option.', 'Placeholders inside [] are not to be translated.', 'gk-gravitymaps' ),
			[
		...
		$gravity_forms_logger_tip = strtr(
			esc_html_x( 'Logging is currently handled by [link]Gravity Forms[/link].', 'Placeholders inside [] are not to be translated.', 'gk-gravitymaps' ),
			[
...
HTML;
		...
		$logger_settings = array_merge( $logger_settings, [
			[
				'id'    => 'logger',
				'type'  => 'checkbox',
				'title' => esc_html__( 'Enable Logging', 'gk-gravitymaps' ),
				'value' => $logger,
			],
			[
				'id'          => 'logger_type',
				'type'        => 'select',
				'title'       => esc_html__( 'Log Type', 'gk-gravitymaps' ),
				'description' => esc_html__( 'Where to store log output.', 'gk-gravitymaps' ),
				'value'       => $logger_type,
				'choices'     => [
					[
						'title' => esc_html__( 'File', 'gk-gravitymaps' ),
						'value' => 'file',
					],
					[
						'title' => esc_html__( 'Query Monitor', 'gk-gravitymaps' ),
						'value' => 'query_monitor',
					],
					[
						'title' => esc_html__( 'Chrome Logger', 'gk-gravitymaps' ),
						'value' => 'chrome_logger',
					],
				],
				'requires'    => [
		...
		$download_notice = strtr(
			esc_html_x( 'Download [link]log file[/link] ([size] / [date_modified]).', 'Placeholders inside [] are not to be translated.', 'gk-gravitymaps' ),
			[
