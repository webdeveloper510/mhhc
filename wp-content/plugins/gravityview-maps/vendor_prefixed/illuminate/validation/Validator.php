...
use GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Support\Arr;
use GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Support\Str;
use GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Support\Fluent;
use GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Support\MessageBag;
use GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Contracts\Container\Container;
use GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator;
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\File\UploadedFile;
use GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Contracts\Container\Container
     */
    protected $container;
     ...
     *
     * @var \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return void
     *
     * @throws \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Validation\ValidationException
     */
     ...
     *
     * @return \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @param  \GravityKit\GravityMaps\Foundation\ThirdParty\Illuminate\Contracts\Container\Container  $container
     * @return void
     */
