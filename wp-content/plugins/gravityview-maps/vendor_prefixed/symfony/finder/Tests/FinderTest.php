...
namespace GravityKit\GravityMaps\Symfony\Component\Finder\Tests;
...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    {
        $this->assertInstanceOf('GravityKit\GravityMaps\Symfony\Component\Finder\Finder', Finder::create());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityMaps\\Symfony\\Component\\Finder\\Finder', Finder::create()->append([]));
    }
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                ...
                $expectedExceptionClass = 'GravityKit\\GravityMaps\\Symfony\\Component\\Finder\\Exception\\AccessDeniedException';
