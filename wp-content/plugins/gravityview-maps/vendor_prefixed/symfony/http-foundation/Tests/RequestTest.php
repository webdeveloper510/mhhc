...
namespace GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Tests;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Request;
...
class RequestTest extends TestCase
{
    ...
    {
        $this->expectException('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException');
        $request = new Request();
    ...
    {
        $class = new \ReflectionClass('GravityKit\\GravityMaps\\Symfony\\Component\\HttpFoundation\\Request');
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Request::setTrustedHeaderName()" method is deprecated since Symfony 3.3 and will be removed in 4.0. Use the $trustedHeaderSet argument of the Request::setTrustedProxies() method instead.
     */
