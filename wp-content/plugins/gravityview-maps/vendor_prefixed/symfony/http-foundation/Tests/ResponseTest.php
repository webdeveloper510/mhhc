...
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Response;
...
class ResponseTest extends ResponseTestCase
{
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Response', $response);
    ...
    {
        $headerMock = $this->getMockBuilder('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\ResponseHeaderBag')->setMethods(['set'])->getMock();
