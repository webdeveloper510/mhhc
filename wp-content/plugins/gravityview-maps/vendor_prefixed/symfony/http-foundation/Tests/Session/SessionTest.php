...
namespace GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Tests\Session;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag;
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Session\Flash\FlashBag;
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Session\Session;
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Session\SessionBagProxy;
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
...
{
    /**
     * @var \GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityMaps\\Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
