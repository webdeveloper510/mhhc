...
use GravityKit\GravityMaps\Symfony\Component\HttpFoundation\StreamedResponse;
...
class StreamedResponseTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\StreamedResponse', $response);
    ...
    public function testReturnThis()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendContent());
        $this->assertInstanceOf('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendContent());

        $response = new StreamedResponse(function () {});
        $this->assertInstanceOf('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
        $this->assertInstanceOf('GravityKit\GravityMaps\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
    }
