 ...
 */
import "./editor.scss";
/*import WPPBBlockContentRestrictionControls from "../../../block-content-restriction/src";*/
import WPPBBlockContentRestrictionControlsCommon from "../../../block-content-restriction/src/controls.js";
    ...
    if (props.attributes.cover) {
        ...
        return (
            <>
                ...
                <div {...useBlockProps()}>
                    <div className="wppb-content-restriction-start-container">
                        <div className="wppb-content-restriction-start-logo">
                            <svg
                                width="24"
                                height="24"
                                aria-hidden="true"
                        ...
                        <div className="wppb-content-restriction-start-title">
                            {__("Content Restriction Start", "profile-builder")}
                        </div>
                    </div>
                </div>
            </>
